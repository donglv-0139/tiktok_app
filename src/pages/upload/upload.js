...
function Upload(props) {
  ...
  const uploadVideo = async (file) => {
    ...
    axios
      .post("https://api.cloudinary.com/v1_1/diw0u2vl1/video/upload", form)
      .then(async (response) => {
        ...
        <div className="upload--main">
          ...
          <div className="upload--main--child">
            <div className="upload--upload--file" onClick={uploadVideoOnClick}>
              <p>Chọn video từ thiết bị của bạn(PNG, WEBP, JPEG)</p>
              <input
                type="file"
                hidden
                id="upload--video"
            ...
            <div className="upload--upload--form">
              ...
              <div
                className={all_hashtag_class}
                onMouseOut={() =>
                  setTimeout(() => setAllHashtagClass("disable"), 2000)
                }
              >
                {all_hashtag.map((tag) => (
                  <button onClick={() => onChooseTag(tag.hashtag_name)}>
                    {tag.hashtag_name}
                  </button>
                ))}
              </div>
      ...
      <div className={clear}>
        <div className="clear--all">
          <h1 className="clear--title">
            Bạn chắc chắn muốn hủy tải video lên?
          </h1>
